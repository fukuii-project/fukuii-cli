...
object Upgrades:
  ...
  val genesisPrices: GasSchedule = GasSchedule(
    ...
    precompilePointEvaluation = BigInt(50000),
    precompileBls12G1Add = BigInt(0),
    precompileBls12G1Mul = BigInt(0),
    precompileBls12G1Map = BigInt(0),
    precompileBls12G2Add = BigInt(0),
    precompileBls12G2Mul = BigInt(0),
    precompileBls12G2Map = BigInt(0),
    precompileBls12PairingBase = BigInt(0),
    precompileBls12PairingPerPair = BigInt(0),
