...
enum Opcode(val code: Int):
  ...
  case Shl extends Opcode(0x1b)
  case Shr extends Opcode(0x1c)
  case Sar extends Opcode(0x1d)
  ...
  case ExtCodeHash extends Opcode(0x3f)
  ...
  case BlobHash extends Opcode(0x49)
  case BlobBaseFee extends Opcode(0x4a)
  ...
  case TLoad extends Opcode(0x5c)
  case TStore extends Opcode(0x5d)
  case MCopy extends Opcode(0x5e)
